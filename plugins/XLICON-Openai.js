...
let handler = async (m, { text, conn, usedPrefix, command }) => {
  ...
  try {
    ...
    try {
      ...
      await conn.sendButton(m.chat,result, author, 'https://telegra.ph/file/fea7726e00b598e921edf.jpg', [['Script', `${usedPrefix}script`]], null, [['Fork Repo', `https://github.com/salmanytofficial/XLICON-V2-MD`]], m)
      m.react(done)
    } catch (error) {
